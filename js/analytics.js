(function() {
    ...
    var oc = function() {
      ...
      , ge = function(a, b, c) {
        1 <= 100 * Math.random() || Aa("?") || (a = ["t=error", "_e=" + a, "_v=j43", "sr=1"],
        b && a.push("_f=" + b),
    ...
    var Qb = T("_oot")
      ...
      , W = T("cookieDomain")
      , Yb = T("cookiePath", void 0, "https://s3.amazonaws.com/")
    ...
    ;var gc = function(a, b) {
        ...
        Ec(c) || Fc(c))) {
            var d = c[Eb];
            void 0 == d || Infinity == d || isNaN(d) || (0 < d ? (Y(c, Gb),
            Y(c, Jb),
            Y(c, Ib),
            Y(c, Fb),
            Y(c, Hb),
    ...
    var hc = !1
      ...
      , kc = function(a) {
        if (!a)
            return "/";
        1 < a.length && a.lastIndexOf("https://s3.amazonaws.com/") == a.length - 1 && (a = a.substr(0, a.length - 1));
        0 != a.indexOf("https://s3.amazonaws.com/") && (a = "/" + a);
        return a
    }
      , jc = function(a) {
        a = kc(a);
        return "/" == a ? 1 : a.split("https://s3.amazonaws.com/").length
    }
    ;
    function Xc(a, b, c) {
        "none" == b && (b = "");
    ...
    var ad, bd = function(a, b, c) {
        if (!ad) {
            ...
            if (e = (d = (d = d && d.match(g) || e && e.match(g)) ? d[1] : Ca("GASO")[0] || "") && d.match(/^(?:!([-0-9a-z.]{1,40})!)?([-.\w]{10,1200})$/i))
                ...
                a = e[1],
                wa("../../analytics.google.com/analytics/web/inpage/pub/inpage.html?" + (a ? "prefix=" + a + "&" : "") + hd(), "_gasojs");
            ad = !0
        }
    }
    ;
    ...
    var u = function(a, b, c) {
      ...
      , y = function(a, b, c, d, e) {
        if (!ea(Yd.get(b)) && !$d.get(b)) {
            ...
            c = b + ".js") : J(43);
            c && (c && 0 <= c.indexOf("https://s3.amazonaws.com/") || (c = (Ba || Ud() ? "https:" : "http:") + "//www.google-analytics.com/plugins/ua/" + c),
            d = ae(c),
            a = d.protocol,
            c = M.location.protocol,
            ("https:" == a || a == c || ("http:" != a ? 0 : "http:" == c)) && B(d) && (wa(d.url, void 0, 
            e),
            $d.set(b, !0)))
        }
    }
      ...
      , B = function(a) {
        ...
        return "www.google-analytics.com" == a.host && (a.port || b) == b && D(a.path, "https://s3.amazonaws.com/plugins/") ? !0 : !1
    }
      , 
    ae = function(a) {
        function b(a) {
            ...
            a = a.pathname || "";
            D(a, "https://s3.amazonaws.com/") || (a = "/" + a);
            return [b, "" + c, a]
        }
        ...
        var d = (c.protocol || "").toLowerCase()
          ...
          , g = c.search || ""
          , ca = d + "//" + e[0] + (e[1] ? ":" + e[1] : "");
        D(a, "//") ? a = d + a : D(a, "https://s3.amazonaws.com/") ? a = ca + a : !a || D(a, "?") ? a = ca + e[2] + (a || g) : 0 > a.split("https://s3.amazonaws.com/")[0].indexOf(":") && (a = ca + e[2].substring(0, e[2].lastIndexOf("https://s3.amazonaws.com/")) + "/" + 
        a);
        c.href = a;
        d = b(c);
        return {
